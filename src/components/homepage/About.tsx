...
const About = () => {
    ...
    return <>
        <FadeInOnScroll className="bg-white dark:bg-[#111111] dark:text-white sm:col-span-4 row-span-3 border border-gray-200 dark:border-[#333333] p-5 rounded-lg transition hover:shadow-sm">
