...
const BeyondCoding = () => {
    ...
    return <>
        <FadeInOnScroll className="bg-white dark:text-white dark:bg-[#111111] dark:border-[#333333] row-span-2 sm:col-span-2 p-5 border border-gray-200 rounded-lg transition hover:shadow-sm">
